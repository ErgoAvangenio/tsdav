...
const DAVAttributeMap = {
    ...
    [exports.DAVNamespace.OWN_CLOUD]: 'xmlns:oc',
};
            ...
            body: {
                propfind: {
                    _attributes: getDAVAttribute([
                        ...
                        exports.DAVNamespace.OWN_CLOUD,
                    ]),
                    prop: props,
                },
            },
...
const fetchCalendars = async (params) => {
    ...
    const res = await propfind({
        ...
        props: customProps !== null && customProps !== void 0 ? customProps : {
            ...
            [`${exports.DAVNamespaceShort.DAV}:sync-token`]: {},
            [`${exports.DAVNamespaceShort.OWN_CLOUD}:calendar-enabled`]: {},
            [`${exports.DAVNamespaceShort.CALDAV_APPLE}:calendar-order`]: {},
            [`${exports.DAVNamespaceShort.DAV}:current-user-privilege-set'`]: {},
        },
        depth: '1',
        headers: excludeHeaders(headers, headersToExclude),
        fetchOptions,
